...
class Cifar10_GAN():
    def __init__(self, train_loader, val_loader, learning_rate, l1_weight,
                 save_path="trained_model.pth.tar"):
    ...
    def train_one_epoch(self, epoch):
        ...
        lossD_val, lossG_val, acc_2, acc_5 = self.validate()
...
class U_Net32():
    def __init__(self, train_loader, val_loader, learning_rate, save_path="trained_UNet_model.pth.tar"):
        self.trained_epoch = 0
    ...
    def train_one_epoch(self, epoch):
        ...
        loss_val, acc_2, acc_5 = self.validate()
...
class GAN_256(Cifar10_GAN):
    def __init__(self, train_loader, val_loader, learning_rate, l1_weight,
                 save_path="trained_256_model.pth.tar"):
        super().__init__(train_loader, val_loader, learning_rate, l1_weight, save_path=save_path)
...
class Unet_256(U_Net32):
    def __init__(self, train_loader, val_loader, learning_rate, save_path="trained_256_UNet_model.pth.tar"):
        super().__init__(train_loader, val_loader, learning_rate, save_path=save_path)
